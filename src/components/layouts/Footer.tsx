...
import { FaArrowUp, FaFacebookF, FaInstagram, FaRegCopyright, FaTwitter } from "react-icons/fa";
...
const Footer = () => {
  ...
  return (
      ...
      <div className="flex flex-col gap-5 md:flex-row items-start justify-between py-8">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm">Office Of The Examination Department, Biratnagar</p>
            </div>
    ...
    {showScroll && (
      <button
        onClick={scrollToTop}
        className="fixed bottom-6 left-[50%] p-3 bg-blue-900 text-white rounded-full shadow-lg hover:bg-blue-950 transition duration-300 cursor-pointer"
      >
        <FaArrowUp size={20} />
      </button>
    )}
